...
export const DashboardHeader = ({ user }: DashboardHeaderProps) => {
  ...
  return (
    <header className="h-20 bg-white/75 backdrop-blur-[20px] border-b border-slate-200/50 flex items-center justify-between px-8 shadow-[0_4px_16px_rgba(0,0,0,0.08),inset_0_1px_0_rgba(255,255,255,0.5)] sticky top-0 z-40">
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-3 px-4 py-2 bg-slate-50/80 backdrop-blur-sm rounded-xl border border-slate-200/60">
          <div className="w-8 h-8 rounded-full bg-gradient-primary flex items-center justify-center shadow-glow-blue">
        ...
        <Button 
          ...
          className="glass-input hover:bg-red-50 hover:border-red-300 hover:text-red-600 transition-all duration-300"
        >
