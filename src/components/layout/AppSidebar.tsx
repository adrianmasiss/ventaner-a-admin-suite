      ...
      <SidebarHeader className="p-4 border-b border-sidebar-border">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-semibold text-sidebar-foreground">Ventanería y</span>
            <span className="text-xs text-sidebar-foreground/80">Mantenimientos S.A.</span>
          </div>
        </div>
      </SidebarHeader>
      <SidebarContent>
