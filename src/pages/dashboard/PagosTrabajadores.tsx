...
const PagosTrabajadores = () => {
  ...
  const fetchWorkerPayments = async () => {
    const { data: visitWorkers, error } = await supabase
      .from("visit_workers")
      .select(`
        id,
        worker_id,
      ...
      .order("visits(start_time)", { ascending: false });
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold">Pagos a Trabajadores</h1>
      </div>
          ...
          <div className="space-y-4">
            ...
            {selectedWorker && (
              <div className="border rounded-lg p-4 space-y-2">
                ...
                {selectedWorker.pending_visits.map((visit) => (
